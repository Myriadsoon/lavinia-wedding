(() => {
  ...
  (() => {
    document.addEventListener("DOMContentLoaded", () => {
      ...
      for (const toastEl of toastElList) {
        const toast = new import_toast.default(toastEl, { autohide: false });
        toast.show();
      }
    });
  })();

  // src/js/_wedding-day-timeline.js
  (function(Drupal2, once2) {
    Drupal2.behaviors.weddingDayTimeline = {
      attach(context) {
        once2(
          ...
          const activateTab = (tab) => {
            ...
            panels.forEach((panel) => {
              const isActive = panel.dataset.timelinePanel === eventId;
  ...
  // src/js/_wedding-photo-moderation.js
  (function(Drupal2, once2) {
    Drupal2.behaviors.weddingPhotoModeration = {
      attach(context) {
        once2(
